...
describe('InsurancePolicyService', () => {
  ...
  describe('business', () => {
    ...
    it('should update an existing policy', () => {
      ...
      const req = httpTestingController.expectOne('http://localhost:5000/update-policy');
    ...
    it('should delete a policy', () => {
      ...
      const req = httpTestingController.expectOne(`http://localhost:5000/delete-policy?id=${policyId}`);
